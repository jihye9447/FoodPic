...
public class AnalyticsFragment extends Fragment implements AnalyticsTask.ViewBridge{
    ...
    private void initView(View view){
        ...
        activation_kcal.findViewById(R.id.actiation_kcal);
        conference_comment.findViewById(R.id.message);
        correct_weight.findViewById(R.id.edit_weight);
        resultString.findViewById(R.id.result_string);
        warning_tips.findViewById(R.id.waring_tips);
        first_picture.findViewById(R.id.first_pic);
        second_picture.findViewById(R.id.second_pic);
